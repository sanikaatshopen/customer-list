...
export class CustomerService {
  ...
  // ── Add a new customer ─────────────────
  addCustomer(data: { name: string; emails: ContactEntity[]; phones: ContactEntity[] }): Observable<Customer> {
  ...
  // ── Update a customer ──────────────────
  updateCustomer(id: string, data: { name: string; emails: ContactEntity[]; phones: ContactEntity[] }): Observable<Customer> {
